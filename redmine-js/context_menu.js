...
function contextMenuRightClick(event) {
  ...
  const mailBlockTop = $(mainBlock).parent().offset().top 
  ...
  contextMenuShow(event, mailBlockTop);
}
...
function contextMenuShow(event, mainBlockTop) {
  var mouse_x = event.pageX;
  var mouse_y = event.pageY - mainBlockTop;  
